...
{
    public class ImportantViewModel : BaseViewModel
    {
        ...
        public ImportantViewModel()
        {
            ...
            DeleteCommand = new RelayCommand<task>((p) => { return true; }, (p) =>
            {
        ...
        private void LoadData()
        {
            ...
            var query = from t in taskTb
                        ...
                        where u.user_id == LoginFormViewModel.UserId && t.important == true
                        select t;
